    ...
    function peg$parse(input, options) {
        ...
        let peg$FAILED = {},
            ...
            peg$c6 = function(ops, jp, pipes) {
                return {operators: ops, path: jp, pipes, source: text(), value: null};
            },
            ...
            peg$c32 = function(op, count) {
                return { operator: op, count};
            },
            peg$c33 = function() {
                return text().trim();
            },
            peg$c34 = function(fn, args) {
                return {function: fn, type: 'inline', args};
            },
            peg$c35 = '@',
            ...
            peg$c61 = function(q1, name, q2) {
                return (q1 || '') + name.join('').trim() + (q2 || '');
            },
            peg$c62 = function(value) {
                return value.length === 0 ? null : value.map((arr) => arr[1]).join('');
            },
